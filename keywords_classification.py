...
keywords_path = os.path.join(HERE, 'keywords')


class KeywordsClassification():
    def __init__(self):
        self.aho, self.keyword_weight, self.keyword_label = self.load_keywords()
